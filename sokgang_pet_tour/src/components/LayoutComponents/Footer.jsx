...
const Footer = () => {
    return (
        <div className={`${classes.main_footer} ${classes.user_footer}`}>
            ...
            <div className={classes.copyright}>@ PetGang Tour.</div>
            <div className={classes.icon_container}>
                <a className={classes.icon_link} href="mailto:okc0202@naver.com">
                    <FaEnvelope className={classes.icon} />
                </a>
                <a className={classes.icon_link} href="https://github.com/ohchanKyu/Nahc-sokgang-pet-tour" target="_blank" rel="noopener noreferrer">
